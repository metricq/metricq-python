...
from ..timeseries import JsonDict, TimeAggregate
...
class PandasHistoryClient:
    """
    This can be used similarly to a :class:`HistoryClient`, but the data methods return
    pandas structures.
    ...
    def client(self) -> HistoryClient:
        """
        Access the underlying :class:`HistoryClient` instance.
        """
        return self._client
