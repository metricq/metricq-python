...
.. glossary::
    ...
    Source
        A :term:`Client` which produces :term:`Data Points <Data Point>` for one or several :term:`Metrics<Metric>` which are then available for consumption by other Clients on the network.
